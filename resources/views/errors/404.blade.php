...
<body>
    ...
    <div id="f0f" data-bg-src="img/background-img/404-bg.jpg">
        <div class="container">
            <div class="row">
                                ...
                                <div class="widget search">
                                    <form action="" method="post">
                                        <div class="input-group">
                                            <input type="text" placeholder="Search" class="form-control"> <span class="input-group-addon"> <button type="submit"><i class="fa fa-search"></i></button> </span> </div>
                                    </form>
                                </div><a href="/" class="btn btn-lg btn-custom-reverse">Go Home</a> </div>
                        </div>
                    </div>
                </div>
            </div>
